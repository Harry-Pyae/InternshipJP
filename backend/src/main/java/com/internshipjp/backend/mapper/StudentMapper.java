...
public class StudentMapper {
    ...
    public StudentProfileResponse toProfile(StudentProfile profile) {
        ...
        dto.setPreferredWorkMode(
                profile.getPreferredWorkMode() == null
                        ? null
                        : profile.getPreferredWorkMode().name()
        );
    ...
    /**
     * Converts one education entity into the response sent to the frontend.
     */
    public StudentEducationResponse toEducation(StudentEducation education) {
        StudentEducationResponse dto = new StudentEducationResponse();
